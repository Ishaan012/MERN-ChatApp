        ...
        <div className='flex flex-col items-center justify-center min-w-96 ax-auto'>
            <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Link to={"/login"} className='text-sm hover:underline hover:text-blue-500 mt-5 inline-block'>
                    ...
                    <div>
                        <button className='btn btn-block btn-sm mt-2 text-blue-500 hover:text-white hover:bg-blue-500 border-blue-500'>Sign Up</button>
                    </div>
                </form>
            </div>
